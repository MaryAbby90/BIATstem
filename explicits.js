define(['questAPI'], function(Quest){
	...
	*/	
	...
	API.addQuestionsSet('att7black',{
		...
		stem: 'Which statement best describes you?',
		answers: [
		{text:'I strongly prefer People of Color (e.g., Black, Latinx and Asian) to White people.',value: 1},
	    {text:'I moderately prefer People of Color (e.g., Black, Latinx and Asian) to White people.',value: 2},
	    {text:'I slightly prefer People of Color (e.g., Black, Latinx and Asian) to White people.',value: 3},
	    {text:'I like People of Color (e.g., Black, Latinx and Asian) and White people equally.',value: 4},
	    {text:'I slightly prefer White people to People of Color (e.g., Black, Latinx and Asian).',value: 5},
	    {text:'I moderately prefer White people to People of Color (e.g., Black, Latinx and Asian).',value: 6},
	    {text:'I strongly prefer White people to People of Color (e.g., Black, Latinx and Asian).',value: 7}

		]
	});
	
	API.addQuestionsSet('blackdiscrimination',{
		inherit : 'basicSelect',
		name: 'blackdiscrimination',
		stem: 'How often do you feel that racial/ethnic groups who are not White, such as Black, Latinx and Asian, are discriminated against, because of their race/ethnicity?',
		answers: [
		{text:'Never',value: 1},
        {text:'Rarely',value: 2},
	...
	API.addQuestionsSet('blackdiscriminationind',{
		inherit : 'basicSelect',
		name: 'blackdiscriminationind',
				...
				data : [
					{
						...
						data : [
							...
							{
								inherit:'basicPage', 
								questions: {inherit:'blackdiscrimination'}							
							},
							{inherit:'basicPage', 
								questions: {inherit:'blackdiscriminationind'}
					}
						]
					}/*,
					{
			...
			//Next, all the other questions
			{
				...
				data : [
			        ...
			        },
					{
						...
						data : [
							    {inherit:'basicPage', 
								questions: {inherit:'blackthreshold'}
							    },
							    {inherit:'basicPage', 
								questions: {inherit:'blackmetabolism'}
							    }
						       ]
			        },
			        {

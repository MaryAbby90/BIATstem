define(['questAPI'], function(Quest){
	...
	*Specific questions
	*/	
    API.addQuestionsSet('att7obesity',{
		inherit : 'basicSelect',
		name: 'att7obesity',
	...
	API.addQuestionsSet('obesityanalgesicdose',{
		inherit : 'basicSelect',
		name: 'obesityanalgesicdose',
		stem: 'Please, rate this statement: People with obesity should receive the same mg/kg dosing of analgesics than people with ideal body weight.',
		answers: [
			{text:'I strongly agree',value: 1},
			{text:'I moderately agree',value: 2},
			{text:'I slightly agree',value: 3},
			{text:'I neither agree nor disagree',value: 4},
			{text:'I slightly disagree',value: 5},
			{text:'I moderately disagree',value: 6},
			{text:'I strongly disagree',value: 7}
		]
	});
	API.addQuestionsSet('obesityanalgesicrisk',{
		inherit : 'basicSelect',
		name: 'obesityanalgesicrisk',
		stem: 'Would you say that the risk of complications from opioids for people with obesity compared to people with ideal body weight is:',
		answers: [
			{text:'Strongly lower',value: 1},
			{text:'Moderately lower',value: 2},
			{text:'Slightly lower',value: 3},
			{text:'The same',value: 4},
			{text:'Slightly greater',value: 5},
			{text:'Moderately greater',value: 6},
			{text:'Strongly greater',value: 7}
		]
	});
	

	API.addQuestionsSet('blackthreshold',{
		inherit : 'basicSelect',
		name: 'blackthreshold',
		stem: 'Would you say that the pain threshold of Black people compared to White people is:',
		answers: [
			{text:'Strongly lower',value: 1},
			{text:'Moderately lower',value: 2},
			{text:'Slightly lower',value: 3},
			{text:'The same',value: 4},
			{text:'Slightly higher',value: 5},
			{text:'Moderately higher',value: 6},
			{text:'Strongly higher',value: 7}
		]
	});
	
	API.addQuestionsSet('hispanicthreshold',{
		inherit : 'basicSelect',
		name: 'hispanicthreshold',
		stem: 'Would you say that the pain threshold of Hispanic people compared to White people is:',
		answers: [
			{text:'Strongly lower',value: 1},
			{text:'Moderately lower',value: 2},
			{text:'Slightly lower',value: 3},
	...
	API.addQuestionsSet('blackmetabolism',{
		inherit : 'basicSelect',
		name: 'blackmetabolism',
		stem: 'Would you say that the metabolization of pain medication in Black people compared to White people is:',
		answers: [
			{text:'Strongly slower',value: 1},
			{text:'Moderately slower',value: 2},
			{text:'Slightly slower',value: 3},
			{text:'The same',value: 4},
			{text:'Slightly quicker',value: 5},
			{text:'Moderately quicker',value: 6},
			{text:'Strongly quicker',value: 7}
		]
	});
	API.addQuestionsSet('hispanicmetabolism',{
		inherit : 'basicSelect',
		name: 'hispanicmetabolism',
		stem: 'Would you say that the metabolization of pain medication in Hispanic people compared to White people is:',
		answers: [
			{text:'Strongly slower',value: 1},
			{text:'Moderately slower',value: 2},
			{text:'Slightly slower',value: 3},
	...
	API.addQuestionsSet('att7black',{
		inherit : 'basicSelect',
		name: 'att7black',
		stem: 'Which statement best describes you?',
		answers: [
			'I strongly prefer Black people to White people.',
			'I moderately prefer Black people to White people.',
			'I slightly prefer Black people to White people.',
			'I like Black people and White people equally.',
			'I slightly prefer White people to Black people.',
			'I moderately prefer White people to Black people.',
			'I strongly prefer White people to Black people.'
		]
	});
	API.addQuestionsSet('att7hispanic',{
		inherit : 'basicSelect',
		name: 'att7hispanic',
		stem: 'Which statement best describes you?',
		answers: [
			'I strongly prefer Hispanic people to White people.',
			'I moderately prefer Hispanic people to White people.',
			'I slightly prefer Hispanic people to White people.',
			'I like Hispanic people and White people equally.',
			'I slightly prefer White people to Hispanic people.',
			'I moderately prefer White people to Hispanic people.',
			'I strongly prefer White people to Hispanic people.'
		]
	});
	
	
    API.addQuestionsSet('att7all',{
		inherit : 'basicSelect',
		name: 'att7all',
		stem: 'Which statement best describes you?',
		answers: [
			'I strongly prefer People of Color (e.g., African Americans, Latinos and Asians) to White People.',
			'I moderately prefer People of Color (e.g., African Americans, Latinos and Asians) to White People.',
			'I slightly prefer People of Color (e.g., African Americans, Latinos and Asians) to White People.',
			'I like People of Color (e.g., African Americans, Latinos and Asians) and White People equally.',
			'I slightly prefer White People to People of Color (e.g., African Americans, Latinos and Asians).',
			'I moderately prefer White People to People of Color (e.g., African Americans, Latinos and Asians).',
			'I strongly prefer White People to People of Color (e.g., African Americans, Latinos and Asians).'
		]
	});
	
	API.addQuestionsSet('groupdiscrimination',{
		inherit : 'basicSelect',
		name: 'groupdiscrimination',
		stem: 'How often do you feel that racial/ethnic groups who are not White, such as African Americans, Latinos and Asians, are discriminated against?',
		answers: [
		    {text:'Never',value: 1},
			{text:'Rarely',value: 2},
	...
	API.addQuestionsSet('introk6',{
		inherit : 'basicSelect',
		name: 'introk6',
		stem: 'These next questions are about your feelings over the past 30 days, including as potentially affected by any racial/ethnic discrimination:',
	    answers: [
	...
	API.addQuestionsSet('nervous',{
		inherit : 'basicSelect',
		name: 'nervous',
		stem: 'During the past 30 days, about how often did you feel nervous?',
		answers: [
    ...
    API.addQuestionsSet('hopeless',{
		inherit : 'basicSelect',
		name: 'hopeless',
		stem: 'During the past 30 days, about how often did you feel hopeless?',
		answers: [
			{text:'All of the time',value: 1},
			{text:'Most of the time',value: 2},
			{text:'Some of the time',value: 3},
	...
	API.addQuestionsSet('restless',{
		inherit : 'basicSelect',
		name: 'restless',
		stem: 'During the past 30 days, about how often did you feel restless or fidgety?',
		answers: [
			{text:'All of the time',value: 1},
			{text:'Most of the time',value: 2},
			{text:'Some of the time',value: 3},
	...
	API.addQuestionsSet('cheer',{
		inherit : 'basicSelect',
		name: 'cheer',
		stem: 'During the past 30 days, about how often did you feel so depressed that nothing could cheer you up?',
		answers: [
			{text:'All of the time',value: 1},
			{text:'Most of the time',value: 2},
			{text:'Some of the time',value: 3},
	...
	API.addQuestionsSet('effort',{
		inherit : 'basicSelect',
		name: 'effort',
		stem: 'During the past 30 days, about how often did you feel that everything was an effort?',
		answers: [
			{text:'All of the time',value: 1},
			{text:'Most of the time',value: 2},
			{text:'Some of the time',value: 3},
	...
	API.addQuestionsSet('worthless',{
		inherit : 'basicSelect',
		name: 'worthless',
		stem: 'During the past 30 days, about how often did you feel worthless?',
		answers: [
			{text:'All of the time',value: 1},
			{text:'Most of the time',value: 2},
			{text:'Some of the time',value: 3},
	...
	API.addQuestionsSet('eod1',{
		inherit : 'basicSelect',
		name: 'eod1',
		stem: 'If you feel you have been treated unfairly, do you usually:',
		answers: [
			{text:'Accept it as a fact of life',value: 1},
			{text:'Try to do something about it',value: 2}
		]
	});
	API.addQuestionsSet('eod2',{
		inherit : 'basicSelect',
		name: 'eod2',
		stem: 'If you have been treated unfairly, do you usually:',
		answers: [
			{text:'Talk to other people about it',value: 1},
			{text:'Keep it to yourself',value: 2}
		]
	});
	...
	/*API.addQuestionsSet('eod3',{
		...
		numericValues:false,
		answers: [
			{text:"At School?", value:"1"},
			{text:"Getting hired or getting a job?", value:"2"},
			{text:"At work?", value:"3"},
			{text:"Getting housing?", value:"4"},
			{text:"Getting medical care?", value:"5"},
			{text:"Getting service in a store or restaurant?", value:"6"},
			{text:"Getting credit, bank loans, or a mortgage?", value:"7"},
			{text:"On the street or in a public setting?", value:"8"},
			{text:"From the police or in the courts?", value:"9"}
			]
	});*/
		...
		API.addSequence([
			//First, we present the three direct liking questions.
			{
				...
				data : [
					...
					{
						inherit:'basicPage', 
						questions: {inherit:'att7black'}
					},
					{
						inherit:'basicPage', 
						questions: {inherit:'att7hispanic'}
					},
					{
						inherit:'basicPage', 
						questions: {inherit:'att7obesity'}
					},*/
					{
						inherit:'basicPage', 
						questions: {inherit:'att7all'}
					}/*,
					{
						inherit:'basicPage', 
						questions: {inherit:'groupdiscrimination'}
					},
					{
						inherit:'basicPage', 
						questions: {inherit:'individualdiscrimination'}
					}*/
				]
			},
			//Next, all the other questions
			{
				...
				data : [
					...
					/*{
						...
						data : [
							...
							},
							{
							    ...
							    /*{inherit:'basicPage', 
								questions: {inherit:'obesityanalgesicdose'}
							    },
							    {inherit:'basicPage', 
								questions: {inherit:'obesityanalgesicrisk'}
							    }
						       ]
			        },*/
					/*{
						...
						data : [{inherit:'basicPage', 
								questions: {inherit:'introk6'}
							    },
							    {inherit:'basicPage', 
								questions: {inherit:'nervous'}
							    },
							    {inherit:'basicPage', 
								questions: {inherit:'hopeless'}
							    },
							    {inherit:'basicPage', 
								questions: {inherit:'restless'}
							    },
							    {inherit:'basicPage', 
								questions: {inherit:'cheer'}
							    },
							    {inherit:'basicPage', 
								questions: {inherit:'effort'}
							    },
							    {inherit:'basicPage', 
								questions: {inherit:'worthless'}
							    }
						       ]
			        },/*,
			        {
						...
						data : [
							    {inherit:'basicPage', 
								questions: {inherit:'hispanicthreshold'}
							    },
							    {inherit:'basicPage', 
								questions: {inherit:'hispanicmetabolism'}
							    }
						       ]
			        }*/
			        
			       {
						...
						data : [
							    {inherit:'basicPage', 
								questions: {inherit:'eod1'}
							    },
							    {inherit:'basicPage', 
								questions: {inherit:'eod2'}
							    },
							    {inherit:'basicPage', 

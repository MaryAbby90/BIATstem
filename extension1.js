	...
	**/
	...
	function iatExtension(options)
	{
		...
		var batObj = 
		{
			...
			attribute1 : 
			{
				name : 'Target of Discrimination', 
				title : {
					media : {word : 'Target of Discrimination'}, 
					css : {color:'#0000FF','font-size':'1.8em'}, 
					height : 4,
					startStimulus : {
						media : {word : 'Target, Victim, Oppressed'}, 
			...
			attribute2 : 
			{
				name : 'Perpetrator of Discrimination', 
				title : {
					media : {word : 'Perpetrator of Discrimination'}, 
					css : {color:'#0000FF','font-size':'1.8em'}, 
					height : 4,
					startStimulus : {
						media : {word : 'Perpetrator, Abuser, Racist'}, 
						css : {color:'#0000FF','font-size':'1em'}, 
						height : 2
					}
				}, 
